    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HoroscopeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HoroscopeName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    HoroscopeDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HoroscopeIcon = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HoroscopeImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Slug = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlogPostName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    BlogPostContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BlogPostImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Slug = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HoroscopeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlogPosts_Horoscopes_HoroscopeId",
                        column: x => x.HoroscopeId,
                        principalTable: "Horoscopes",
                        principalColumn: "HoroscopeId",
                        onDelete: ReferentialAction.Cascade);
                });
